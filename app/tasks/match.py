...
from app.tasks.detect import detect
from app.tasks.preprocess import embed_image
from models import SurferFrame, UserEmbedding  # absolute import of ORM models
